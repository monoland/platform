<template>
    ...
    >
        <v-sheet class="overflow-hidden" rounded="lg">
            <div class="px-4 pt-4 pb-3 text-h6">Kenaikan Pangkat</div>
                ...
                <v-stepper-items>
                        ...
                        <v-sheet :color="`grey lighten-4`" class="ma-1" rounded="lg">
                            <v-card-text class="px-5">
                                <v-row>
                                    <v-col md="12">
                                        <v-textarea
                                            label="Alasan Pengajuan Kartu Pegawai"
                                            auto-grow
                                            hide-details
                                        ></v-textarea>
                                    </v-col>
                    ...
                    <v-stepper-content step="2">
                        <v-sheet :color="`grey lighten-4`" class="ma-1 px-4 py-1" rounded="lg">
                            <mono-file-upload
                                class="mb-3"
                                label="Dokumen Surat Keputusan (SK) Pangkat Terakhir"
                                hint="Tap disini pilih file dari perangkat Anda."
                            ></mono-file-upload>

                            <mono-file-upload
                                class="mb-3"
                                label="Dokumen Sasaran Kinerja Pegawai (SKP) - 2019"
                                hint="Tap disini pilih file dari perangkat Anda."
                            ></mono-file-upload>

                            <mono-file-upload
                                class="mb-3"
                                label="Dokumen Sasaran Kinerja Pegawai (SKP) - 2020"
                                hint="Tap disini pilih file dari perangkat Anda."
                            ></mono-file-upload>
                        </v-sheet>
                        ...
                        <v-sheet :color="`grey lighten-4`" class="ma-1 px-4 py-1" rounded="lg">
                            ...
                            <v-simple-table class="mt-2 v-data-table--nohover">
                                <template v-slot:default>
                                    <tbody>
                                        <tr>
                                            <td class="overline grey--text text--darken-1">Dokumen Surat Keputusan (SK) Pangkat Terakhir</td>
                                            <td class="text-right">{{ record.name }}</td>
                                        </tr>

                                        <tr>
                                            <td class="overline grey--text text--darken-1">Dokumen Sasaran Kinerja Pegawai (SKP) - 2019</td>
                                            <td class="text-right">{{ record.name }}</td>
                                        </tr>

                                        <tr>
                                            <td class="overline grey--text text--darken-1">Dokumen Sasaran Kinerja Pegawai (SKP) - 2020</td>
                                            <td class="text-right">{{ record.name }}</td>
                                        </tr>
                                    </tbody>
                                </template>
