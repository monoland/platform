...
use App\Http\Resources\Organization\EmptinessCollection;
use App\Http\Resources\Organization\EmptinessShowResource;
use App\Models\Organization\Formation;
use Illuminate\Http\Request;

class EmptinessController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return new EmptinessCollection(
    ...
    public function show(Formation $formation)
    {
        ...
        return new EmptinessShowResource($formation);
    }
