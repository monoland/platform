...
class ExecutorPolicy
{
    ...
    {
        return $user->hasPermission('show-reference-executor');
    }
    ...
    {
        return $user->hasPermission('view-reference-executor');
    }
    ...
    {
        return $user->hasPermission('create-reference-executor');
    }
    ...
    {
        return $user->hasPermission('update-reference-executor');
    }
    ...
    {
        return $user->hasPermission('delete-reference-executor');
    }
    ...
    {
        return $user->hasPermission('restore-reference-executor');
    }
    ...
    {
        return $user->hasPermission('destroy-reference-executor');
    }
}
